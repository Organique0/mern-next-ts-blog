    ...
    return (
        ...
        >
            <span className="d-flex align-items-center w-fit-content">
                <Image src={user.profilePicUrl || profilePlaceholder} width={40} height={40} alt={"profile pic user: " + user.username} className="rounded-circle" />
...
function UserTooltipContent({ user: { username, about, profilePicUrl, createdAt } }: UserTooltipContentProps) {
    return (
        <div className="p-2">
            <Image
                src={profilePicUrl || profilePlaceholder}
                width={100}
                height={100}
